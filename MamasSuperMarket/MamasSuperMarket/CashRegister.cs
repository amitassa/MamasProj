...
namespace MMSuperMarket
{
    ...
    {
        public List<ProductType> ProductsBought { get; } // List of all products bought at this cash register
        public Dictionary<Customer, DateTime> CustomerHistory { get; } // History of all customers checked out at this cash register
        public List<RegisterLog> CashierHistory { get; } // History of all cashiers used this cash register
        public RegisterLog CurrentUse { get; set; } // The current use of a cashier at this cash register
        public List<Customer> CustomersQueue { get; } // The line for this cash register
        public bool IsStarted { get; set; } // Is a cashier using this cash register now
        public string RegisterNumber { get; } // The number of this cash register

        public CashRegister(string registerNumber)
        {
            this.ProductsBought = new List<ProductType>();
            this.CustomerHistory = new Dictionary<Customer, DateTime>();
            this.CashierHistory = new List<RegisterLog>();
            this.CustomersQueue = new List<Customer>();
