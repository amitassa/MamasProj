...
namespace MamasSuperMarket.BLL
{
    public static class InventoryHandler
    {
        ...
        {
            var table = new ConsoleTable("Order ID", "Product Ordered", "Amount", "Status");
            List<ProductOrder> Temp_POList = Inventory.Instance.GetOrderDB();
            foreach(var PO in Temp_POList)
            {
                table.AddRow(PO.OrderID, PO.productType.Name, PO.OrderAmount, PO.OrderStatus);
            }
